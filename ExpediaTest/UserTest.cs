...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveCarFromServiceLocatorWhenBooked()
        {
            ...
            Assert.AreEqual(remainingCar, ServiceLocator.Instance.AvailableCars[0]);        }

        [TestMethod()]
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(), new DateTime(), 500);
            var remainingFlight = new Flight(new DateTime(), new DateTime(), 500);
            ...
            Assert.AreEqual(remainingFlight, ServiceLocator.Instance.AvailableFlights[0]);
